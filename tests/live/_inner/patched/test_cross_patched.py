...
CROSS_PLATFORM = os.environ["_XBUILD_PLATFORM"]
CROSS_ARCH = os.environ["_XBUILD_ARCH"]
...
EXPECTED = ALL_COMMON_EXPECTED[CROSS_PLATFORM][CROSS_ARCH]
EXPECTED.update(ALL_EXPECTED.get(CROSS_PLATFORM, {}).get(CROSS_ARCH, {}))
